    ...
    <header className={`${isLoggedIn ? "bg-[#288037]" : "bg-[#97db51]"}`}>
      ...
      >
        <div className="flex items-center justify-between w-full lg:w-auto">
          ...
          <div className="flex-1 flex justify-center pr-10">
            <Link to={isLoggedIn ? `/${userId}/dashboard` : "/"} className="-m-1.5 p-1.5">
          ...
          <div className="flex lg:hidden">
            <Link
              to={isLoggedIn ? `/${userId}/myaccount` : "/signin"}
        ...
        <Popover.Group
          className={`${
            isLoggedIn
              ? "text-white hidden lg:flex lg:gap-x-12 ml-auto pl-10"
              : "text-black hidden lg:flex lg:gap-x-12 ml-10 pl-10"
          }`}
        >
          {isLoggedIn && (
            <Link
        ...
        <div
          className={`${
            isLoggedIn
              ? "hidden lg:flex lg:flex-1 lg:justify-end text-white"
              : "hidden lg:flex lg:flex-1 lg:justify-end text-black"
          }`}
        >
          {isLoggedIn ? (
            <>
              <Link
                to={`/${userId}/dashboard`}
                className="text-sm font-semibold leading-6 pl-2 "
              >
      ...
      >
        ...
        <Dialog.Panel
          className={`${
            isLoggedIn
              ? "text-white fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#288037] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
              : " text-black fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#97db51] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
          }`}
        >
                  ...
                  <Link
                    ...
                    className={`${
                      isLoggedIn
                        ...
                        : "-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-black hover:bg-red-orange"
                    }`}
                  >
                    Manual Investment
                  </Link>
