  ...
  return (
    <div>
      ...
      <div className="px-12 py-10 flex justify-center">
        <p>
          Need help? Chat with our Investment Assistant by clicking on the chat
          bubble in the corner of the screen.
          <br />
          <br />
          Looking for further assistance? Email our Support Team at
          accountsupport@monarch.com
        </p>
      </div>
