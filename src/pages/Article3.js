...
function Article3() {
  return (
    <div>
      ...
      <div className='pt-5'>
        <h1 className='text-4xl font-bold pt-5 pl-5'>Money Saving Tips</h1>
        <h2 className='text-3xl font-semibold pt-5 pl-5'>5 Tips to Double your Savings in One Year</h2>
